...
public enum GLLang {
	...
	ITEM$UMBRELLA_MODE("Mode: %s", 1),
	ITEM$UMBRELLA_SLOT("Slot: %s", 1),
	ITEM$UMBRELLA_SLOT_EMPTY("Empty slot", 0, ChatFormatting.DARK_GRAY),
	ITEM$UMBRELLA_LOCKED_TRAVEL("Travel mode locked: apply chorus fruit in anvil", 0, ChatFormatting.DARK_RED),
	ITEM$UMBRELLA_LOCKED_CAPTURE("Capture mode locked: apply echo shard in anvil", 0, ChatFormatting.DARK_RED),
	ITEM$UMBRELLA_RECORDED("Recorded position %s: %s", 2),
	ITEM$UMBRELLA_WAYPOINT("Teleported to %s", 1),
	ITEM$UMBRELLA_TRAVEL_START("Charging border travel...", 0),
	ITEM$UMBRELLA_TRAVEL_DONE("Border travel complete", 0),
	ITEM$UMBRELLA_CAPTURED("Teleported %s to %s", 2),
	ITEM$UMBRELLA_CAPTURE_FAIL("Cannot capture this entity", 0, ChatFormatting.RED),
	ITEM$UMBRELLA_TRAVEL_CANCELLED("Travel cancelled", 0, ChatFormatting.GRAY),
	ITEM$UMBRELLA_DIM_MISSING("Dimension %s not found", 1),
	ITEM$UMBRELLA_RENAME_TITLE("Rename Position", 0),
	ITEM$UMBRELLA_WHEEL("Hold %s to open wheel", 1, ChatFormatting.GRAY),
	...
	UMBRELLA$MODE_TRAVEL("Travel"),
	UMBRELLA$MODE_CAPTURE("Capture"),
	UMBRELLA$SLOT_EMPTY("Empty"),
	UMBRELLA$WHEEL_TARGET("Target Position"),
	UMBRELLA$WHEEL_DISTANCE("Travel Distance"),
	UMBRELLA$WHEEL_EDIT("Edit Position"),
	UMBRELLA$MANAGE_TITLE("Manage Positions"),
	UMBRELLA$MANAGE_RENAME("Rename"),
	UMBRELLA$MANAGE_DELETE("Delete"),
