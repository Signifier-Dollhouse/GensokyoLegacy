...
import dev.xkmc.gensokyolegacy.content.item.talisman.data.TalismanPocketData;
...
public class GLTalismans {
	...
	private static void genPaperItemModel(String name, RegistrateItemModelProvider pvd, String preset) {
		pvd.getBuilder(name)
				.parent(new ModelFile.UncheckedModelFile("item/generated"))
				.texture("layer0", pvd.modLoc("item/talisman/" + preset + "_talisman_paper"))
				.texture("layer1", pvd.modLoc("item/talisman/" + preset + "_talisman_paper_overlay"));
	}
